    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-pdse-navy/70 to-pdse-navy/50">
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1551524164-6cf874fedf2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2426&q=80')`
          }}
        />
      </div>
